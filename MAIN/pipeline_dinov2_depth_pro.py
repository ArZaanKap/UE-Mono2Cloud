...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="MAIN pipeline: DINOv2 mask + Depth Pro depth + LAS export"
    )
    ...
    parser.add_argument("--output-dir", default=None, help="Output directory (default: MAIN/pointclouds_dinov2_depth_pro)")
    ...
    output_dir_name = "dpro" if input_dir is not None else "pointclouds_dinov2_depth_pro"
    ...
    try:
        ...
        run_model_subprocess(MODEL_KEY, edited_path, str(depth_tmp))
    ...
    stem = f"{dataset_label}_{args.mask_model}_depth_pro"
